...
import { RevokeLicensesFromUsersModal } from './RevokeLicensesFromUsersModal';
...
describe('<RevokeLicensesFromUsersModal>', () => {
  ...
  it('should render', async () => {
    ...
    expect(screen.getByText('Remove multiple licenses')).toBeInTheDocument();
    expect(
